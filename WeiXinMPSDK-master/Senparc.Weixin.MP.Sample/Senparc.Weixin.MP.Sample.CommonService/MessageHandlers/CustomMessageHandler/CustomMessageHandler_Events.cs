...
//        }
        private string GetWelcomeInfo()
        {
            ...
            var version = string.Format("{0}.{1}", fileVersionInfo.FileMajorPart, fileVersionInfo.FileMinorPart);
            return string.Format(
@"欢迎关注【69cheng 官方微信公众平台】，当前运行版本：v{0}。
您可以直接点击菜单查看各种类型的回复。
【69cheng官方地址：http://www.69cheng.com/】
【69cheng官方微信开发：倪新生】",
                version);
        }
                ...
                case "WDQB"://我的钱包
                    {
                        var strongResponseMessage = CreateResponseMessage<ResponseMessageText>();
                        reponseMessage = strongResponseMessage;
                        strongResponseMessage.Content = "【我的钱包升级维护中】详情咨询官方热线:400-089-6099";//（六九城官方400电话）
                    }
                    break;
                case "SQRZ"://申请认证
                    {
                        var strongResponseMessage = CreateResponseMessage<ResponseMessageText>();
                        reponseMessage = strongResponseMessage;
                        strongResponseMessage.Content = "【申请认证升级维护中】详情咨询官方热线:400-089-6099";//（六九城官方400电话）
                    }
                    break;
                case "SubClickRoot_Text"://联系客服
                    {
                        var strongResponseMessage = CreateResponseMessage<ResponseMessageText>();
                        reponseMessage = strongResponseMessage;
                        strongResponseMessage.Content = "官方热线:400-089-6099";//（六九城官方400电话）
                    }
                    break;
                case "SubClickRoot_News"://委托出售
                    {
                        ...
                        {
                            Title = "六九城欢迎您",
                            Description = "详细敬请咨询六九城【69cheng】官方热线:400-089-6099",
                            PicUrl = "http://wvqusrtg.wicp.net/Images/69chengQRCode.png",//取服务器上图片地址
                            //Url = "http://www.69cheng.com/"
                            Url = "http://wvqusrtg.wicp.net/Images/69chengQRCode.png"//跳转链接到的服务器上的地址（这里临时也指向了一张图片）
                        });
                    }
                    break;
                case "SubClickRoot_Music"://图片的上传接收服务器端接收（这里详细后台如何接收要研究的）
                    {
                        //上传缩略图
        ...
        public override IResponseMessageBase OnEvent_LocationRequest(RequestMessageEvent_Location requestMessage)
        {
            ...
            //responseMessage.Content = "【69cheng微信开发倪新生提醒您】：这里是微信客户端（通过微信服务器）自动发送过来的位置信息！";
